...
class AppKernel extends Kernel
{
    ...
    {
        $bundles = [
            new Foody\InstallerBundle\FoodyInstallerBundle(),
            new Foody\ImportProductBundle\FoodyImportProductBundle(),
        ];
    ...
    {
        if ('vagrant' === parent::getEnvironment()) {
            return sys_get_temp_dir() . '/akeneo';
        }
    ...
    {
        if ('vagrant' === parent::getEnvironment()) {
            return '/home/vagrant/logs/akeneo/' . $this->getEnvironment();
        }
