 ...
 */
class Channel extends \Pim\Bundle\CatalogBundle\Entity\Channel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'label', 'category', 'currencies', 'locales', 'conversionUnits', 'color');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategory(\Pim\Bundle\CatalogBundle\Model\CategoryInterface $category)
    {
     ...
     * {@inheritDoc}
     */
    public function addCurrency(\Pim\Bundle\CatalogBundle\Model\CurrencyInterface $currency)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCurrency', array($currency));
    ...
    public function getLocaleCodes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLocaleCodes', array());
     ...
     * {@inheritDoc}
     */
    public function addLocale(\Pim\Bundle\CatalogBundle\Model\LocaleInterface $locale)
    {
