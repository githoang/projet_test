 ...
 */
class Locale extends \Pim\Bundle\CatalogBundle\Entity\Locale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'activated', 'channels');
        }
     ...
     * {@inheritDoc}
     */
    public function addChannel(\Pim\Bundle\CatalogBundle\Model\ChannelInterface $channel)
    {
