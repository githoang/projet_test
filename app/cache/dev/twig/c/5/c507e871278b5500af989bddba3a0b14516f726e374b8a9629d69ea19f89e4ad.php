...
/* PimEnrichBundle:Product:_edit_without_comparison.html.twig */
class __TwigTemplate_e53de6cb529e3807a03424f154d5d2282dc39a27e9f14b0ebc4801656120f344 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        ";
            ...
            if (($this->getAttribute($context["attributeView"], "isRemovable", array()) && $this->env->getExtension('oro_security_extension')->checkResourceIsGranted("pim_enrich_product_remove_attribute"))) {
                // line 15
                echo "            <i ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["elements"]) ? $context["elements"] : $this->getContext($context, "elements")), "deleteLinkAttributes", array(0 => $this->env->getExtension('routing')->getPath("pim_enrich_product_removeattribute", array("productId" => $this->getAttribute(                // line 16
...
(isset($context["product"]) ? $context["product"] : $this->getContext($context, "product")), "id", array()), "dataLocale" => (isset($context["dataLocale"]) ? $context["dataLocale"] : $this->getContext($context, "dataLocale")))), 2 => $this->env->getExtension('translator')->trans("confirmation.product.remove attribute", array("%name%" => $this->getAttribute(                // line 18
...
";
    ...
    {
        return "PimEnrichBundle:Product:_edit_without_comparison.html.twig";
    }
