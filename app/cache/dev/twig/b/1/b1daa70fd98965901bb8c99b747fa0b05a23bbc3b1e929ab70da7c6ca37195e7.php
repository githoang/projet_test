...
class __TwigTemplate_003369f4139888ade662d5b1847794bcb6c40b8dfc6a5e1d007349da40c4bf43 extends Twig_Template
{
...
/* {% block head %}*/
/*     {{ parent() }}*/
/*     <script type="text/javascript" src="{{ asset('bundles/oroui/lib/bootstrap/js/bootstrap-scrollspy.js') }}"></script>*/
/* {% endblock %}*/
/* {% block main %}*/
/*     <div>*/
/*     {% block right_panel %}*/
...
/*                     <div class="span9 ">*/
/*                        <div class="customer-info well-small">*/
/*                            <div class="visual"><img src="{{ asset('bundles/oroui/img/info-user.png') }}" alt="user avatar"/></div>*/
/*                            <div class="customer-content">*/
/*                                <div class="sub-title">Customers</div>*/
/*                                <h1 class="user-name">Anna Griffin</h1>*/
/*                                <ul class="inline">*/
