...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Hostname of the VM (use in ansible inventory : app/ansible/dev)
  config.vm.hostname = "pim-foody-dev"
  ...
  config.vm.provision "ansible" do |ansible|
    ansible.inventory_path = "app/ansible/dev"
    ansible.playbook = "app/ansible/app.yml"
    ansible.extra_vars = {
      uservar: "vagrant"
    }
    ansible.limit= "all"
